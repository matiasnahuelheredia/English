...
const getTenseName = (tenseId) => {
  const tenseNames = {
    ...
    'future-forms-b1': 'Future: will / going to / -ing (B1)',
    'conditionals-b1': 'Conditionals 0/1/2 (B1)',
    'modals-obligation-b1': 'Modals: must / have to / should (B1)',
    'passive-b1': 'Passive (B1)',
    'reported-speech-b1': 'Reported Speech (B1)',
    'relative-clauses-b1': 'Relative Clauses (B1)',
    'used-to-b1': 'Used to (B1)',
    'question-tags-b1': 'Question Tags (B1)',
    'quantifiers-b1': 'Quantifiers (B1)',
