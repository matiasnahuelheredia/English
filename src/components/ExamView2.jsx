...
const ExamView2 = () => {
  ...
  const generateAIPrompt = () => {
    let prompt = `Act as a B2 level English teacher specialized in cybersecurity. I have completed a technical exam and I need you to analyze my mistakes and explain which concepts I should reinforce.\n\n`;
    prompt += `📊 RESULTS:\n`;
    ...
    prompt += `\n🎯 PLEASE ANALYZE:\n`;
    prompt += `1. What error patterns do I make? (issues with verb tenses, prepositions, technical vocabulary?)\n`;
    prompt += `2. Which specific technical English concepts should I reinforce?\n`;
