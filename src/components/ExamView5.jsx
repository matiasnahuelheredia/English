...
import { getExam5Sections, getTotalExam5Exercises } from '../data/examData5';
import SuccessModal from './SuccessModal';
import { useSuccess } from '../hooks/useSuccess';

const ExamView5 = () => {
  const [sections] = useState(getExam5Sections());
  ...
  const totalExercises = getTotalExam5Exercises();
